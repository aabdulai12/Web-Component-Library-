...
L.cloneElement = function (e, n, t) {
  ...
  if (n != null) {
    if (
      (n.ref !== void 0 && ((u = n.ref), (o = ju.current)),
...
function Yl(e) {
  ...
  if (typeof e == "object")
    switch (e.$$typeof) {
      ...
      case Qu:
        return (
          (n = e.displayName || null), n !== null ? n : Yl(e.type) || "Memo"
        );
      case Ge:
...
function Gl(e, n) {
  ...
  n.hasOwnProperty("value")
    ? Zl(e, n.type, t)
    : n.hasOwnProperty("defaultValue") && Zl(e, n.type, cn(n.defaultValue)),
    n.checked == null &&
...
function vs() {
  if (Qn) {
    var e = Qn,
      n = Kn;
    if (((Kn = Qn = null), Ho(e), n)) for (e = 0; e < n.length; e++) Ho(n[e]);
  }
}
function hs(e, n) {
  return e(n);
...
function Fc(e, n, t, r, l, u, o, i, s) {
  (kt = !1), (Lr = null), Dc.apply(Ic, arguments);
}
function jc(e, n, t, r, l, u, o, i, s) {
  if ((Fc.apply(this, arguments), kt)) {
    if (kt) {
      var c = Lr;
      (kt = !1), (Lr = null);
...
function Jc(e, n, t, r, l) {
  switch (n) {
    ...
    case "gotpointercapture":
      return (
        (u = l.pointerId), Mt.set(u, ct(Mt.get(u) || null, e, n, t, r, l)), !0
      );
  }
  return !1;
}
...
function ft(e, n) {
  e.blockedOn === n &&
    ...
    ou ||
      ((ou = !0),
      he.unstable_scheduleCallback(he.unstable_NormalPriority, qc)));
}
function Dt(e) {
  function n(l) {
    return ft(l, e);
...
var lt = {
  ...
  el = A({}, Xt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== dt &&
            (dt && e.type === "mousemove"
              ? ((Cl = e.screenX - dt.screenX), (_l = e.screenY - dt.screenY))
              : (_l = Cl = 0),
            (dt = e)),
          Cl);
    },
  ...
  Go = ge(el),
  tf = A({}, el, { dataTransfer: 0 }),
  rf = ge(tf),
  lf = A({}, Xt, { relatedTarget: 0 }),
  xl = ge(lf),
  uf = A({}, lt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  of = ge(uf),
  sf = A({}, lt, {
...
var xf = He && "TextEvent" in window && !Et,
...
function ti() {
  Ct && (Ct.detachEvent("onpropertychange", $s), (It = Ct = null));
}
function $s(e) {
...
function Rf(e, n, t) {
  e === "focusin"
    ? (ti(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", $s))
    : e === "focusout" && ti();
}
function Of(e) {
...
var jf = He && "documentMode" in document && 11 >= document.documentMode,
  In = null,
  su = null,
  _t = null,
  au = !1;
...
function tl(e) {
  ...
  var n = Fn[e],
    t;
  for (t in n) if (n.hasOwnProperty(t) && t in Bs) return (zl[e] = n[t]);
  return e;
}
var Hs = tl("animationend"),
  Ws = tl("animationiteration"),
  Qs = tl("animationstart"),
  Ks = tl("transitionend"),
  Ys = new Map(),
  oi =
...
var wt =
  ...
  Af = new Set("cancel close invalid load scroll toggle".split(" ").concat(wt));
function ii(e, n, t) {
...
function Xs(e, n) {
  ...
  if (Tr) throw ((e = lu), (Tr = !1), (lu = null), e);
}
function D(e, n) {
  var t = n[mu];
  t === void 0 && (t = n[mu] = new Set());
  var r = e + "__bubble";
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              h !== null &&
              ((d = h),
              f !== null && ((h = Rt(a, f)), h != null && S.push(Ut(a, h, d)))),
            F)
          )
            break;
          a = a.return;
...
function I(e) {
  0 > Un || ((e.current = vu[Un]), (vu[Un] = null), Un--);
}
function M(e, n) {
  Un++, (vu[Un] = e.current), (e.current = n);
}
var fn = {},
  re = pn(fn),
  ce = pn(!1),
...
function cr(e) {
  ...
  if (
    ((n = e.tag !== 3) &&
      !(n = e.tag !== 5) &&
      ((n = e.type),
      (n = n !== "head" && n !== "body" && !du(e.type, e.memoizedProps))),
    n && (n = me))
  ) {
    if (hu(e)) throw (ea(), Error(y(418)));
...
function vo(e, n, t, r, l, u) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (Er.current = e === null || e.memoizedState === null ? ed : nd),
    (e = t(r, l)),
    xt)
  ) {
    u = 0;
...
function ya(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), ul(4, 4, ha.bind(null, n, e), t)
  );
}
function go() {}
function ga(e, n) {
...
function Sa(e, n, t) {
  return Pn & 21
    ? (Oe(t, n) || ((t = xs()), ($.lanes |= t), (Nn |= t), (e.baseState = !0)),
      n)
  ...
  ed = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        ...
        Cr(4194308, 4, ha.bind(null, n, e), t)
      );
    },
...
function zi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    _r(e, n), xa(n, t, r), Su(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
    ...
    (o.state = p),
      ...
      i !== r || p !== s || ce.current || Ze
        ? (typeof v == "function" && (wu(n, t, v, r), (s = n.memoizedState)),
    ...
    i !== m || p !== w || ce.current || Ze
      ? (typeof g == "function" && (wu(n, t, g, r), (w = n.memoizedState)),
...
function ud(e, n, t, r, l, u, o) {
  if (t)
    return n.flags & 256
      ? ((n.flags &= -257), (r = $l(Error(y(422)))), dr(e, n, o, r))
      : n.memoizedState !== null
        ...
        (e === null || e.child === null) &&
          (cr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Le !== null && (Du(Le), (Le = null)))),
        Pu(e, n),
        ne(n),
        null
      );
      ...
      return n.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((n.child.flags |= 8192),
            n.mode & 1 &&
              (e === null || U.current & 1 ? Y === 0 && (Y = 3) : xo())),
          n.updateQueue !== null && (n.flags |= 4),
          ne(n),
          null);
    case 4:
      return (
        et(), Pu(e, n), e === null && jt(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function cd(e, n) {
  ...
  for (fu = { focusedElem: e, selectionRange: t }, Mr = !1, k = n; k !== null; )
...
function ja(e) {
  ...
  n !== null && ((e.alternate = null), ja(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[$t], delete n[mu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Lu(e, n, t) {
  ...
  if (r === 5 || r === 6)
    ...
    for (Lu(e, n, t), e = e.sibling; e !== null; ) Lu(e, n, t), (e = e.sibling);
}
function Tu(e, n, t) {
  var r = e.tag;
  if (r === 5 || r === 6)
...
function Re(e, n, t, r) {
  ...
  Yt(e, t, r),
    (!(R & 2) || e !== Z) &&
      ...
      de(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((tt = W() + 500), ll && mn()));
}
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Qo(t), n === 1))
      e.tag === 0 ? Xf(ji.bind(null, e)) : Js(ji.bind(null, e)),
        Wf(function () {
          !(R & 6) && mn();
        }),
        (t = null);
...
function Ba(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = uu(e)), l !== 0 && ((r = l), (n = Mu(e, l)))), n === 1)
    )
    ...
    if (n === 6) qe(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = Eo + 500 - W()), 10 < n))
          ) {
            if (Or(e, 0) !== 0) break;
...
Xa = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return (ae = !1), od(e, n, t);
      ae = !!(e.flags & 131072);
    }
  ...
  switch (((n.lanes = 0), n.tag)) {
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            Su(n, r, e, t),
            (n = Cu(null, n, r, !0, u, t)))
          : ((n.tag = 0), j && u && to(n), le(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
    ...
    case 5:
      return (
        ...
        (o = l.children),
        du(r, l) ? (o = null) : u !== null && du(r, u) && (n.flags |= 32),
        Ta(e, n),
        le(e, n, o, t),
        n.child
      );
...
function Nr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) Po(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Wl:
        return (
          (e = ke(12, t, n, l | 2)), (e.elementType = Wl), (e.lanes = u), e
        );
      case Ql:
        return (e = ke(13, t, n, l)), (e.elementType = Ql), (e.lanes = u), e;
      case Kl:
        return (e = ke(19, t, n, l)), (e.elementType = Kl), (e.lanes = u), e;
      case us:
        return al(t, l, u, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Xu(n, t | 1), de(n, W()), !(R & 6) && ((tt = W() + 500), mn()));
      }
      break;
    case 13:
      zn(function () {
...
hs = Co;
ys = zn;
var Pd = { usingClientEntryPoint: !1, Events: [Gt, jn, rl, ms, vs, Co] },
  vt = {
  ...
  Nd = {
    ...
    findFiberByHostInstance: vt.findFiberByHostInstance || _d,
...
ec(document.getElementById("root")).render(
  Io.jsx($u.StrictMode, { children: Io.jsx(Ld, {}) }),
);
